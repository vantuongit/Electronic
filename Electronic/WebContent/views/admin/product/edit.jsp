        	...
        	List<Category> categories = (List<Category>)request.getAttribute("categories");
      		...
      		List<Producer> producer = (List<Producer>)request.getAttribute("producer");
    		   ...
    		   if(product != null){
    			   ...
    			   cat_id = String.valueOf(product.getCategory().getId());
    			   producer_id = String.valueOf(product.getProducer().getId());
    			   picture = product.getPicture();
    			   price = String.valueOf(product.getPrice());
    			   old_price = String.valueOf(product.getOld_price());
                            ...
                            <div class="col-md-12">
                                <form role="form" method="post" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <% if(!picture.isEmpty()){ %>
                                         <br />
                                         <img with="200px" height="200px" ="ảnh" src="<%=request.getContextPath()%>/uploads/<%=picture%>" />
                                        <%} %>
                                    </div>
                                   <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <label for="old_price">Gía cũ</label>
